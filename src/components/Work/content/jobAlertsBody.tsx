  ...
  <div className="space-y-8">
    ...
    <div>
      ...
      <ul className="space-y-1 text-gray-600 leading-relaxed mt-2">
        <li>
          — <b>Make the functionality more clear.</b> It'll be a success if we
          see an increase in the number of users who set an alert from 1% to 5%.
        </li>
        <li>
      ...
      <p>
        Because our job boards integrate with our customers' websites, it's
        always important to make sure we don't ship something that will conflict
        with their brand.
      </p>
    </div>
    ...
    <div>
      ...
      />
      <p>
        The project motivation and goals were clear, so it was time to start
        with research.
      </p>
      <p className="text-xl font-medium text-gray-800 leading-relaxed my-10 px-10">
        Having released a first iteration to a few early access customers
        allowed us having real usage data and real feedback from users and those
        customers.
      </p>
      ...
      <ol className="space-y-2 text-gray-600 leading-relaxed mt-3">
        <li>
          — The button to turn on job alerts was often missed. The button
          position was disconnected from the jobs, making some users forget
          about it or not see it as relevant.
        </li>
        <li>
          — Users needed to validate their email by clicking a link sent to
          their inbox. This step was adding friction, causing a 28% drop on the
          funnel.
        </li>
        <li>
          — Once the user started scrolling through jobs, the CTA was not
          visible anymore. HotJar sessions showed us that users spent most time
          after scrolling down to filters and results.
        </li>
      </ol>
    </div>
    ...
    <div>
      ...
      <p className="text-xl font-medium text-gray-800 leading-relaxed my-10 px-10">
        ...
        what we should focus on. Once the main issues were clear, we detected
        the areas where we could maximize impact:
      </p>
      <p>
      ...
      <ul className="space-y-2 text-gray-600 leading-relaxed mt-3">
        <li>
          — Email validation step: understand why it's there, its legal
          implications and check if we can remove it.
        </li>
        <li>
          — Make job alerts visible when they are more relevant: when the user
          has set some filters and their attention was grabbed by jobs relevant
          to them.
        </li>
        <li>
          — Guidance for first time users: make sure this feature is correctly
          introduced to new users, highlighting the ease of use, relevancy of
          jobs and value for the user.
        </li>
        <li>
    ...
    <div>
      ...
      <p className="text-xl font-medium text-gray-800 leading-relaxed my-10 px-10">
        Rombo, our design system, helped us generate prototypes fast, which
        helped us get real feedback early.
      </p>
      <p>
    ...
    <div>
      ...
      <p>
        ...
        together to review the work to be done and create smaller stories that
        can be shipped on their own while the whole UX makes sense.
      </p>
      <p className="text-xl font-medium text-gray-800 leading-relaxed my-10 px-10">
    ...
    <div>
      ...
      <p>
        During these 2 weeks we got the designs ready to be implemented,
        including early validation with prototypes and engineering reviews.
      </p>
      <p>
        The next 2-week sprint was time to build, supporting the engineers to
        make sure they don't get blocked.
      </p>
      <p>
        After shipping all the stories for this iteration, it was time to
        measure impact! Let’s see how this work impacted each goal during the
        first 2 weeks after releasing every change:
      </p>
      ...
      <p>
        ...
        iteration, we fixed the issues from the first one by making sure the
        whole team was aligned and increasing collaboration between product
